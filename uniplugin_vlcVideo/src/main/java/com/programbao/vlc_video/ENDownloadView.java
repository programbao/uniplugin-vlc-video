...
public class ENDownloadView extends View {
    ...
    public ENDownloadView(Context context, AttributeSet attrs) {
        ...
        int lineColor = ta.getColor(0, DEFAULT_LINE_COLOR);
        int bgLineColor = ta.getColor(0, DEFAULT_BG_LINE_COLOR);
        int textColor = ta.getColor(0, DEFAULT_TEXT_COLOR);
        int lineWidth = ta.getInteger(0, DEFAULT_LINE_WIDTH);
        int bgLineWidth = ta.getInteger(0, DEFAULT_BG_LINE_WIDTH);
        int textSize = ta.getInteger(0, DEFAULT_TEXT_SIZE);
